    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($rows as $row) {
                    ?>
                    <tr class="clickable-row" onclick="window.location.href='ver.php?id=<?php echo $row['Id'] ?>';">
                        <td><?php echo $row['Id'] ?></td>  
                        <td><?php echo $row['encabezado'] ?></td>  
                        <td><?php echo $row['Fecha'] ?></td>  
                        <td>
                            <!-- Icono de edición con clase 'action-link' para evitar activar el evento onclick de la fila -->
                            <a href="editar.php?id=<?php echo $row['Id'] ?>" class="action-link">
                                <i class="fa-solid fa-pen-to-square fs-5 me-3"></i>
                            </a>
                            <!-- Icono de eliminación con clase 'action-link' para evitar activar el evento onclick de la fila -->
                            <a href="eliminar.php?id=<?php echo $row['Id'] ?>" class="action-link">
